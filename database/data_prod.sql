...
(8,'2026-08-09 23:38:22','2026-09-25','14:00:00','1','avenue','du Général Leclerc','33200','Bordeaux','France',15,180.00,0.00,18.00,162.00,'cancelled',0,14,7),
...
(11,'2026-08-12 16:00:33','2026-08-26','16:00:00','5','place','de l\'Hôtel de ville','15300','Murat','France',12,540.00,223.30,0.00,763.30,'completed',0,17,1),
(12,'2026-09-03 13:03:06','2026-09-11','14:30:00','12','rue','de la Liberté','33200','Bordeaux','France',25,1375.00,0.00,137.50,1237.50,'completed',0,14,4),
(13,'2026-09-10 21:45:27','2026-09-11','19:30:00','1','rue','blo ton luc','78140','trou land','ici',80,4400.00,5.00,440.00,3965.00,'completed',0,24,4),
(14,'2026-09-18 23:36:15','2026-09-22','19:30:00','2','rue','de Paris','78000','Versailles','France',14,224.00,345.43,22.40,547.03,'completed',0,25,8),
(15,'2026-09-20 00:54:55','2026-09-25','14:30:00','12','rue','de la Liberté','33200','Bordeaux','France',9,144.00,0.00,14.40,129.60,'accepted',0,14,8);
...
(20,'Houmous','Houmous de pois chiche accompagné de pignon de pin','starter');
...
(35,'pending','2026-09-18 23:36:15',NULL,NULL,14),
(36,'completed','2026-09-19 22:07:27','','',14),
(37,'in_delivery','2026-09-19 22:51:03','','',11),
(38,'pending','2026-09-20 00:54:55',NULL,NULL,15),
(39,'pending','2026-09-20 01:13:51','je n\'en veux plus','',8),
(40,'completed','2026-09-20 01:47:52','','',11),
(41,'accepted','2026-09-20 01:50:58','','',12),
(42,'accepted','2026-09-20 01:51:30','','',13),
(43,'accepted','2026-09-20 01:51:39','','',15),
(44,'completed','2026-09-20 01:52:02','','',12),
(45,'completed','2026-09-20 01:52:19','','',13);
...
(1,'Menu Noël Prestige','Un menu raffiné pour sublimer vos fêtes de fin d\'année. Foie gras, saumon et bûche maison.',10,45.00,8,'À commander minimum 7 jours avant la prestation. Conservation au réfrigérateur entre 0 et 4°C.',0,1,1),
...
(12,'Sunday brunch','Assortiment idéal pour vos dimanches matin en famille ou entre amis',5,17.00,10,'A réserver avant la veille 18h. Conserver au frais et réchauffer selon les instructions 30 minutes avant le service',0,3,4);
...
(4,'ceci est un test','ceci est un test','voilaUnTest@mail.fr','2026-09-17 23:25:45'),
(5,'bref','brefbref ces','bref@voilivoilou.com','2026-09-17 23:49:43'),
(6,'ceswvfws','werfdsxgws∂ﬁ≈','userBordeaux@mail.fr','2026-09-17 23:53:20'),
(7,'222','vwdrbdrhwfhxd','userBordeaux@mail.fr','2026-09-17 23:57:20'),
(8,'retest','bcesjfhsfqhfq','blabla.bla@blo.com','2026-09-18 23:18:17'),
(9,'blatest','testsetstes','blabla.bla@blo.com','2026-09-20 00:52:08');
...
(21,'/assets/images/uploads/img_6aaf0832b7bd00.53643067.jpg','salade thaï','salade thaï','salade-tha-i',0,20);
...
(13,'/assets/images/uploads/dish_starter_foieGras_001.png','Photo test','Photo de test pour tous les plats','photo-test',0,12),
(14,'/assets/images/uploads/img_6aa17e76838c91.58294790.png','Bûche de Noël vanille','Bûche de Noël à la vanille fourrée à la crème de marron','b-uche-de-no-el-vanille',0,1);
...
(3,4,'Menu délicieux et quantités suffisantes\r\nEquipe très chaleureuse malgré un petit retard de livraison','validated','2026-09-19 22:30:14',14,25);
...
(14,'48969a17-b50d-6d20-6ef7-fc5cf522d128','userBordeaux@mail.fr','$2y$12$PMNM0nBRJ3x9jpUG7dqHiuhLLcgNyTuVlgf7AgCoWm56rk6df.kku','NomTest','PrenomTest','0707070706','12','rue','de la Liberté','33200','Bordeaux','France',1,NULL,NULL,'2026-08-07 14:43:39','2026-09-20 01:15:06',1),
...
(25,'0ec849dc-2b23-f657-38db-a89dde73681f','deleted_25@deleted.fr','$2y$12$ZSMEsPjZ05FGBSTAEUICY.9mA81qV2PI5d/VQf1MH6Gvo72hfOANO','Compte','Supprimé','','','','','','','',0,NULL,NULL,'2026-09-18 23:21:20','2026-09-20 01:35:40',1);
...
-- Dump completed on 2026-09-20 16:16:17
